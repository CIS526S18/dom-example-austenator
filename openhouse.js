...
var clock = document.createElement('div');
    ...
    var node = document.getElementById(elementId).appendChild(clock);
}

createCountdown('all-university', Date.parse('2018-04-7'))
createCountdown('engineering', Date.parse('2018-04-6'));